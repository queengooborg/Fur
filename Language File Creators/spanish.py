...
'p1m14':"...I'm %s.",
'p1m15':"%s...it's a funny name for a %s like %s!",
'p1m16':"Wait, what?",
'p1m17':"You then look down at yourself.  %s",
'foxdesc':"You also look just like a fox, almost as if you and %s were twins.",
...
'otterdesc':"However your hands look more like an otter's.  You feel your face and find wet quills.  Behind you is a slim tail.",
'p1m19':"You start to panic inside.  Just then, you look into a nearby mirror.  You hardly recognize yourself and think 'what is going on?'",
'p1m20':"...What?",
'p1m21':"You tell yourself to calm down so you can figure out why you're half-%s.",
'p1m22':"But I-I'm human...",
'p1m23':"The last part was accidentally said out loud.  You meant only to think it.",
'p1m24':"WHAT!  You can't be a human, you've got every aspect of a %s anthro...(%s comes close to you and sniffs you, then pulls back)...and you smell just like one too.",
'p1m25':"Yeah, thanks for that observation.",
'p1m26':"I didn't mean it like that!",
'p1m27':"You didn't mean to say that sarcastically, but you did not appreciate %s's comment.",
'p1m28':"I don't know what's going on.  I wake up, and I'm half-%s.  But...we're going to have to find out.  But before that, where are we?",
