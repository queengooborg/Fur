...
'savewarning':'ATENCION: Archivo en uso de %s %s el/la %s.  ¿Bien para sobrescribir?',
'saveerror':'Archivo no valido',
'colorerror':'Color no valido',
'inputerror':'Entrada no valida',
'nofriendnameerror':"¡No entra el nombre de tu amigo!  Recuerda, %s es un(a) %s.",
...
'mailto2':'Gracias por jugar a Fur!  Por favor envie sus comentarios pulsando en mi.',  # continue correcting VVV
...
'setupgndr':'Estas un niño o una niña?',
'setuprace':"Hace un click en un animal.",
'setupname':'Tu nombre es?',
'setuplast':'%s...y tu apellido?',
'setupeyeclose':'%s %s...Bueno.  Ahora puede entrar por las puertas y se encuentra en "Fur"...cerrar los ojos y contar hasta 3, y despues abra los ojos...',
'setupeyeopen':"Debisa abrir tus ojos ahorra.  Bueno.  Esto se completa tu renacimiento.  Entraras Quilar como medio/a-%s...",
'p1m1':'???: ...',
'p1m2':'???: ...Oye...',
'p1m3':'???: ...Despierta...',
'p1m4':'???: ...¡Oye, %s perezoso!',
...
'p1m7':"???: ¡Estas despierta!  ¡Temblo para una hora ó mas!", # continue translating VVV
...
'chestdescopen':"A chest that contains %s and is %s.",
'chestdescclosed':'A closed chest.',
