...
'setup5':"Debisa abrir tus ojos ahorra.  Bueno.  Esto se completa el primero parte de tu renacimiento.",
'setup6':"La parte final de tu renacimiento es para saber que animal serias si no podia ser humano mas.",
'setup7':"H ace un click en un animal",
'setup8':"Elegida un(a) %s.  Bueno...Este concluye la parte segunda de tu renacimiento.  Entraras Quilar como medio/a-%s...",
'p1m1':'???: ...',
'p1m2':'???: ...Oye...',
'p1m3':'???: ...Despierta...',
'p1m4':'???: ...Oye, %s perezoso!',
'p1m5':'???: Despierta!', # continue translating VVV
'p1m6':'Lentamente abre tus ojos.  Un(a) %s de tu edad esta tratando a temblar despierto.  Se nota algo extraño de el/la %s, pero sus ojos aum estan borrosas de despertar.',
