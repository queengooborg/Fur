...
'save3':'Zix inu Vit',
'save4':'Ka Vit',
'savewarning':'DEXINU: Vit belik inu %s %s shen %s.  Fako inu penshiwelna?',
'saveerror':'Leko ai ronen zix vit.',
'colorerror':'Gelor quekso heni Karonen.',
'inputerror':'Karonen Quekso',
'nofriendnameerror':"Fek bexaleko quksai fekshu coilar nome!  Inacua, %s heli ai %s.",
